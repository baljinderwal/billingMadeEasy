...
router.post('/:id/launch', authorize(['admin', 'marketing']), CampaignController.launchCampaign);
router.post('/:id/pause', authorize(['admin', 'marketing']), CampaignController.pauseCampaign);
